...
from .nfl_utils.elo_utils import calculate_win_probability, calculate_mov_multiplier
from .nfl import get_teams_names

from pandas import DataFrame, isna

def get_elo_ratings_df(schedule: DataFrame, current_week: int) -> DataFrame:
    ...
    for week in range(1, current_week):
        ...
        for index, game in week_schedule.iterrows():
            ...
            home_team_win_probability = calculate_win_probability(away_team_elo = away_team_elo, home_team_elo = home_team_elo)

            # Caculate Margin of Victory multiplier
            mov_bonus = calculate_mov_multiplier(point_difference = result, home_team_elo = home_team_elo, away_team_elo = away_team_elo)
